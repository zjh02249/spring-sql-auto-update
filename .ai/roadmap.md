...
- [x] v1.2.9.14: 修复 SqlExecutor NPE 问题 (connection.getCatalog() 返回 null)

#### 里程碑
- ✅ **v1.0.0**: 基础功能完成
- ✅ **v1.2.0**: Spring Boot Starter 发布
- ✅ **v1.2.7**: 首次 Maven 仓库发布
- ✅ **v1.2.9.14**: NPE 问题修复，项目稳定
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2026-02-27 | v1.2.9.14 | 修复 SqlExecutor NPE 问题 |
| 2026-02-27 | v1.2.9.4 | 修复 SQL 执行失败后重复插入历史记录问题 |
| 2026-02-25 | v1.2.9.3 | 修复 SQL 执行后未切换回默认数据库问题 |
| 2026-02-25 | v1.2.9.1 | 修复反引号格式 SQL 执行问题 |
| 2026-02-25 | v1.2.9 | 修复库名.表名格式 SQL 执行问题 |
| 2026-02-13 | v1.2.7 | 首次发布到 Maven 仓库 |
| 2026-02-12 | v1.2.4 | 修复编译错误，添加 AI 协作框架 |
| 2026-02-11 | v1.2.0 | 修复 SQL 分割逻辑 BUG |
| 2026-01-15 | v1.0.0 | 基础功能完成 |
